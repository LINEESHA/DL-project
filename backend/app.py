...
model = tf.keras.models.load_model("trained_model/coconut_tree.h5")

# Load class indices and disease descriptions (for predictions)
with open("C:\\Users\\linee\\OneDrive\\Documents\\leaf_disease\\coconut_leaf_disease\\backend\\class_indices.json", "r") as f:
    class_indices = json.load(f)

with open("C:\\Users\\linee\\OneDrive\\Documents\\leaf_disease\\coconut_leaf_disease\\backend\\disease_descriptions.json", "r") as f:
